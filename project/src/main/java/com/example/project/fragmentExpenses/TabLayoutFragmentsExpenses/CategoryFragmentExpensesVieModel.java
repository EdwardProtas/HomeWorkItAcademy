...
public class CategoryFragmentExpensesVieModel extends ViewModel {
    ...
    CategoryFragmentExpensesVieModel(ExpensesDataBaseRepository expensesDataBaseRepository, Expenses expenses) {
    ...
    public LiveData<List<Expenses>> getExpensesCategoryLiveData(String category) {
