...
public class AllFragmentExpensesViewModel extends ViewModel {
    ...
    AllFragmentExpensesViewModel(ExpensesDataBaseRepository expensesDataBaseRepository, Expenses expenses) {
