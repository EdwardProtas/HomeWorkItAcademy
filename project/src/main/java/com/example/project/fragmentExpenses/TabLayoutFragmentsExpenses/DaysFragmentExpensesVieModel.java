...
public class DaysFragmentExpensesVieModel extends ViewModel {
    ...
    DaysFragmentExpensesVieModel(ExpensesDataBaseRepository expensesDataBaseRepository, Expenses expenses) {
